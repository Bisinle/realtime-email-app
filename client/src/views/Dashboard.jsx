    ...
    if (currentUser?._id) {
      axiosApi
        ...
        .then((res) => {
          setStats({
            totalEmails:
              res.data.user.sentEmails.length +
              res.data.user.receivedEmails.length,
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-white rounded-lg shadow p-6 border border-gray-200">
          ...
          <p className="text-3xl font-bold text-gray-900">
          <Number n={stats.sentEmails.length}/>
          </p>
          <Link
            to="/inbox/sentEmails"
        ...
        <div className="bg-white rounded-lg shadow p-6 border border-gray-200">
          ...
          <p className="text-3xl font-bold text-gray-900">
            <Number n={stats.receivedEmails.length}/>
          </p>
          <Link
        ...
        <div className="flex items-start space-x-4">
          ...
          <div className="flex-1">
            ...
            <p className="mb-4 text-indigo-100">
              Send emails that are delivered instantly! Our real-time
              notification system ensures your recipients are notified the
              moment you hit send.
            </p>
            <Link
              to="/compose-email"
